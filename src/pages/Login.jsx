...
export default function CyberSecurityAuthPage() {
  ...
  // Menyesuaikan ukuran ikon berdasarkan layar
        ...
        <div className="w-full max-w-md">
          ...
          <div className="min-h-64 sm:min-h-72 md:min-h-80 lg:min-h-96 flex flex-col">
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 md:space-y-5 flex-1">
              ...
              <motion.button
                type="submit"
                className="flex w-full justify-center items-center space-x-2 rounded-lg bg-blue-600 px-4 py-2 text-xs font-medium text-white hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 sm:py-2.5 md:text-sm lg:py-3"
