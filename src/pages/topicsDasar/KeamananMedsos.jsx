import { User, Shield, AlertTriangle, ChevronRight, ChevronLeft, ArrowLeft, Target } from 'lucide-react';
...
export const KeamananMedsos = {
  ...
  content: (
    <KeamananMedsosContent />
  )
};

function KeamananMedsosContent() {
  const [currentView, setCurrentView] = useState('material'); // 'material' atau 'quiz'

  if (currentView === 'quiz') {
    return <KeamananMedsosQuiz onBack={() => setCurrentView('material')} />;
  }
      ...
      <div className="bg-gradient-to-br from-purple-50 to-blue-50 p-6 rounded-2xl border-2 border-purple-200 shadow-md">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-gray-600 mb-4 text-sm">
            Jawab beberapa pertanyaan untuk menguji seberapa baik Anda memahami materi keamanan media sosial.
          </p>
          <button
...
function KeamananMedsosQuiz({ onBack }) {
  ...
  const questions = [
    {
      q: "Apa risiko utama dari oversharing di media sosial?",
      options: [
        "Membuat akun lebih populer",
        "Menyediakan informasi untuk social engineering",
    ...
    {
      q: "Mengapa penting untuk memverifikasi akun sebelum menerima permintaan pertemanan?",
      options: [
        "Untuk menghindari akun palsu yang mungkin melakukan social engineering",
        "Agar timeline lebih rapi",
        "Karena platform media sosial mewajibkannya",
        "Untuk mendapatkan lebih banyak followers"
      ],
      correct: 0
    },
    {
      q: "Apa yang harus dilakukan jika menerima pesan mencurigakan dengan link tidak dikenal?",
      options: [
        "Klik link tersebut untuk melihat isinya",
        "Bagikan ke teman-teman untuk memperingatkan mereka",
        "Hapus dan laporkan pesan tersebut",
        "Simpan link tersebut untuk dibuka nanti"
      ],
      correct: 2
    },
    {
      q: "Kasus Cambridge Analytica menunjukkan pentingnya...",
      options: [
        "Menggunakan banyak aplikasi di media sosial",
        "Memahami dan membatasi izin aplikasi terhadap data pribadi",
        "Membagikan informasi sebanyak mungkin",
        "Membuat banyak akun media sosial"
      ],
      correct: 1
    },
    {
      q: "Manakah yang BUKAN praktik keamanan media sosial yang baik?",
      options: [
        "Menggunakan autentikasi dua faktor (2FA)",
        "Login dengan akun media sosial di berbagai situs web",
        "Mengatur privasi akun ke level tertinggi",
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h2 className="text-2xl font-bold">Keamanan Media Sosial</h2>
            </div>
                  ...
                  {questions[step].options.map((opt, idx) => (
                    <button
                      ...
                      className={`w-full text-left px-5 py-4 rounded-xl border transition-all duration-200
                        ${answers[step] === idx
                          ? 'bg-purple-50 border-blue-300 font-medium text-blue-800 shadow-sm'
            ...
            <div className="text-center">
              <div className="mb-8">
                ...
                <p className="text-gray-600 max-w-md mx-auto">
                  {correctCount === questions.length
                    ? "Anda menguasai materi tentang keamanan media sosial dengan sangat baik!"
                    : correctCount >= 3
                    ? "Pemahaman Anda sudah cukup baik tentang keamanan media sosial."
                    : "Anda perlu mempelajari kembali materi keamanan media sosial."}
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <button
                  onClick={onBack}
                  className="px-8 py-3 rounded-lg bg-gradient-to-r from-purple-500 to-purple-600 text-white font-semibold hover:from-blue-600 hover:to-blue-700 transition-colors shadow-md"
                >
                  Kembali ke Materi
                </button>
              </div>
