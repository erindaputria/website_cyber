import { Shield, Lock, Network, User, Server, Target, ArrowLeft, ChevronRight, ChevronLeft } from 'lucide-react';
...
function ZeroTrustArchitectureContent() {
  const [currentView, setCurrentView] = useState('material'); // 'material' or 'quiz'

  if (currentView === 'quiz') {
    return <ZeroTrustArchitectureQuiz onBack={() => setCurrentView('material')} />;
  }
    ...
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl shadow-xl">
        ...
        <div className="relative z-10 p-8 flex flex-col sm:flex-row items-center gap-6">
          ...
          <div>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-2 drop-shadow">Zero Trust Architecture</h2>
            <p className="text-blue-100 max-w-2xl text-base sm:text-lg font-medium drop-shadow">
              Model keamanan yang berasumsi bahwa ancaman bisa berasal dari dalam maupun luar jaringan dengan prinsip 
              "never trust, always verify" - tidak ada entitas yang dipercaya secara implisit.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-br from-blue-50 via-white to-blue-50 p-7 rounded-2xl border border-blue-200 shadow-lg hover:shadow-xl transition-all">
          <div className="flex items-center mb-4">
            ...
            <h4 className="font-semibold text-blue-800 text-lg">Prinsip Dasar</h4>
          </div>
          <ul className="space-y-4">
            <li>
              <div className="flex items-start">
                ...
                <div>
                  <span className="font-medium text-gray-800">Verifikasi Eksplisit</span>
                  <p className="text-sm text-gray-600 mt-1">Autentikasi dan otorisasi terus-menerus untuk semua akses</p>
                </div>
              </div>
            </li>
            <li>
              <div className="flex items-start">
                ...
                <div>
                  <span className="font-medium text-gray-800">Akses Minimal</span>
                  <p className="text-sm text-gray-600 mt-1">Hanya berikan akses yang benar-benar diperlukan</p>
                </div>
              </div>
            </li>
            <li>
              <div className="flex items-start">
                ...
                <div>
                  <span className="font-medium text-gray-800">Asumsi Jaringan Terkompromi</span>
                  <p className="text-sm text-gray-600 mt-1">Selalu waspada terhadap ancaman internal</p>
                </div>
              </div>
            </li>
            <li>
              <div className="flex items-start">
                ...
                <div>
                  <span className="font-medium text-gray-800">Micro-segmentation</span>
                  <p className="text-sm text-gray-600 mt-1">Membagi jaringan menjadi zona keamanan kecil</p>
                </div>
              </div>
            </li>
          </ul>
        ...
        <div className="bg-gradient-to-br from-indigo-50 via-white to-indigo-50 p-7 rounded-2xl border border-indigo-200 shadow-lg hover:shadow-xl transition-all">
          <div className="flex items-center mb-4">
            ...
            <h4 className="font-semibold text-indigo-800 text-lg">Komponen Utama</h4>
          </div>
          <ul className="space-y-4">
            <li>
              <div className="flex items-start">
                ...
                <div>
                  <span className="font-medium text-gray-800">Identity & Access Management</span>
                  <p className="text-sm text-gray-600 mt-1">Autentikasi multi-faktor dan manajemen identitas terpusat</p>
                </div>
              </div>
            </li>
            <li>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">Verifikasi kesehatan perangkat sebelum mengizinkan akses</p>
                </div>
              </div>
            </li>
            <li>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">Jaringan yang tidak terlihat sampai pengguna diautentikasi</p>
                </div>
              </div>
            </li>
            <li>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">Analisis perilaku dan deteksi anomali secara real-time</p>
                </div>
              </div>
            </li>
          </ul>
      ...
      <div className="bg-gradient-to-r from-indigo-50 to-indigo-100 p-8 rounded-2xl border border-indigo-200 shadow-lg">
        <div className="flex items-center mb-6">
          ...
          <h4 className="font-bold text-2xl text-indigo-900">Implementasi Zero Trust</h4>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all">
            ...
            <h5 className="font-medium text-indigo-600 mb-2">Manajemen Identitas</h5>
          ...
          <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all">
            ...
            <h5 className="font-medium text-indigo-600 mb-2">Keamanan Perangkat</h5>
            <p className="text-sm text-gray-600">
          ...
          <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all">
            ...
            <h5 className="font-medium text-indigo-600 mb-2">Segmentasi Jaringan</h5>
            <p className="text-sm text-gray-600">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-8 rounded-2xl border border-blue-200 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all">
            ...
            <h5 className="font-medium text-blue-600 mb-2">Verifikasi Berlapis</h5>
            <p className="text-sm text-gray-600">
              Gunakan autentikasi multi-faktor untuk semua pengguna dan sistem
            </p>
          </div>
          <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all">
            <div className="bg-indigo-100 p-3 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
            ...
            <h5 className="font-medium text-blue-600 mb-2">Least Privilege</h5>
            <p className="text-sm text-gray-600">
          ...
          <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all">
            ...
            <h5 className="font-medium text-blue-600 mb-2">Monitoring Real-time</h5>
            <p className="text-sm text-gray-600">
              Implementasikan analisis perilaku dan deteksi anomali secara terus-menerus
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-2xl border-2 border-blue-200 shadow-md">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-gray-600 mb-4 text-sm">
            Jawab beberapa pertanyaan untuk menguji seberapa baik Anda memahami arsitektur Zero Trust.
          </p>
          <button
...
// Quiz Component
function ZeroTrustArchitectureQuiz({ onBack }) {
  ...
  const questions = [
    {
      q: "Apa prinsip utama dari arsitektur Zero Trust?",
      options: [
        "Trust but verify",
    ...
    {
      q: "Manakah yang BUKAN komponen utama Zero Trust?",
      options: [
        "Identity & Access Management",
        "Endpoint Security",
        "Open ports for easy access",
        "Continuous Monitoring"
      ],
      correct: 2
    },
    {
      q: "Apa tujuan dari micro-segmentation dalam Zero Trust?",
      options: [
        "Mempercepat jaringan",
        "Membagi jaringan menjadi zona keamanan kecil",
    ...
    {
      q: "Mengapa prinsip least privilege penting dalam Zero Trust?",
      options: [
        "Memberikan akses penuh kepada semua pengguna",
        "Hanya memberikan akses yang benar-benar diperlukan",
        "Mengurangi jumlah pengguna sistem",
        "Membuat sistem lebih mudah digunakan"
      ],
      correct: 1
    },
    {
      q: "Apa manfaat utama dari continuous monitoring?",
      options: [
        "Mengurangi kebutuhan akan autentikasi",
        "Mendeteksi anomali dan ancaman secara real-time",
        "Menghilangkan kebutuhan akan firewall",
        "Mengotomatiskan semua proses bisnis"
      ],
      correct: 1
    }
  ];
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h2 className="text-2xl font-bold">Zero Trust Architecture</h2>
            </div>
            ...
            <div className="text-center">
              <div className="mb-8">
                ...
                <p className="text-gray-600 max-w-md mx-auto">
                  {correctCount === questions.length
                    ? "Anda menguasai materi tentang Zero Trust Architecture dengan sangat baik!"
                    : correctCount >= 3
                    ? "Pemahaman Anda sudah cukup baik tentang Zero Trust Architecture."
                    : "Anda perlu mempelajari kembali materi Zero Trust Architecture."}
                </p>
              </div>
