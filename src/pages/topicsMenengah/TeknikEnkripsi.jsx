import { Lock, Key, Hash, EyeOff, Wifi, Server, Shield, Cpu, Database, ChevronRight, ChevronLeft, ArrowLeft, Target } from 'lucide-react';
...
export const TeknikEnkripsi = {
  ...
  content: (
    <TeknikEnkripsiContent />
  )
};

function TeknikEnkripsiContent() {
  const [currentView, setCurrentView] = useState('material'); // 'material' or 'quiz'

  if (currentView === 'quiz') {
    return <TeknikEnkripsiQuiz onBack={() => setCurrentView('material')} />;
  }
    ...
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl shadow-xl">
        ...
        <div className="relative z-10 p-8 flex flex-col sm:flex-row items-center gap-6">
          ...
          <div>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-2 drop-shadow">Teknik Enkripsi</h2>
            <p className="text-indigo-100 max-w-2xl text-base sm:text-lg font-medium drop-shadow">
              ...
              Teknologi ini menjadi tulang punggung keamanan digital modern.
            </p>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-indigo-50 to-blue-50 p-6 rounded-2xl border-2 border-indigo-200 shadow-md">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-gray-600 mb-4 text-sm">
            Jawab beberapa pertanyaan untuk menguji seberapa baik Anda memahami materi teknik enkripsi.
          </p>
          <button
...
// Quiz Component
function TeknikEnkripsiQuiz({ onBack }) {
  ...
  const questions = [
    {
      q: "Apa perbedaan utama antara enkripsi simetris dan asimetris?",
      options: [
        "Enkripsi simetris lebih cepat dari asimetris",
        "Enkripsi asimetris menggunakan kunci tunggal",
        "Enkripsi simetris tidak memerlukan pertukaran kunci",
        "Enkripsi asimetris menggunakan kunci yang sama untuk enkripsi dan dekripsi"
      ],
      correct: 0
    },
    {
      q: "Algoritma enkripsi mana yang menggunakan konsep kurva eliptik?",
      options: [
        "AES-256",
        "RSA",
        "ECC",
    ...
    {
      q: "Manakah yang BUKAN contoh implementasi enkripsi data in transit?",
      options: [
        "TLS/SSL",
        "BitLocker",
        "VPN",
    ...
    {
      q: "Apa keuntungan utama enkripsi homomorfik?",
      options: [
        "Memungkinkan komputasi pada data terenkripsi",
        "Lebih cepat dari enkripsi simetris",
        "Tidak memerlukan kunci dekripsi",
        "Dapat diimplementasikan tanpa perangkat keras khusus"
      ],
      correct: 0
    },
    {
      q: "Mengapa AES-256 dianggap sangat aman?",
      options: [
        "Karena menggunakan kunci 256-bit yang sulit dipecahkan",
        "Karena tidak memerlukan pertukaran kunci",
        "Karena menggunakan kunci asimetris",
        "Karena dapat diimplementasikan tanpa algoritma"
      ],
      correct: 0
    }
  ];
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-blue-700 p-6 text-white">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h2 className="text-2xl font-bold">Teknik Enkripsi</h2>
            </div>
            ...
            <div className="text-center">
              <div className="mb-8">
                ...
                <p className="text-gray-600 max-w-md mx-auto">
                  {correctCount === questions.length
                    ? "Anda menguasai materi tentang teknik enkripsi dengan sangat baik!"
                    : correctCount >= 3
                    ? "Pemahaman Anda sudah cukup baik tentang teknik enkripsi."
                    : "Anda perlu mempelajari kembali materi teknik enkripsi."}
                </p>
              </div>
