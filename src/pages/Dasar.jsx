import { Shield, Lock, ChevronLeft, ChevronRight, Wifi, BookOpen, ArrowLeft } from 'lucide-react';
import { useState } from 'react';
import React from 'react';

// Import topics
import { PengenalanCyber } from './topicsDasar/PengenalanCyber';
import { KeamananPassword } from './topicsDasar/KeamananPassword';
import { VirusMalware } from './topicsDasar/VirusMalware';
import { PhishingDanSocialEngineering } from './topicsDasar/Pishing&Social';
import { AutentikasiDuaFaktor } from './topicsDasar/Autentikasi';
import { UpdateDanPatchManagement } from './topicsDasar/Update&Patch';
import { KeamananJaringan } from './topicsDasar/KeamananJaringan';
import { KeamananMobile } from './topicsDasar/KeamananMobile';
import { KeamananMedsos } from './topicsDasar/KeamananMedsos';
import { EtikadanHukum } from './topicsDasar/EtikadanHukum';
...
export default function Dasar({ onBack }) {
  ...
  const topics = [
    ...
    KeamananPassword,
    VirusMalware,
    PhishingDanSocialEngineering,
    AutentikasiDuaFaktor,
    UpdateDanPatchManagement,
    KeamananJaringan,
    KeamananMobile,
    KeamananMedsos,
    EtikadanHukum
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-indigo-100">
      <div className="animate-fade-in mx-auto px-4 sm:px-6 pt-8 sm:pt-12 lg:pt-16 max-w-7xl">
        {/* Enhanced Back Button */}
        <button
          onClick={onBack}
          className="flex items-center gap-2 px-6 py-3 mb-6 sm:mb-8 md:mb-10 text-blue-600 hover:text-blue-800 transition-all duration-300 rounded-full bg-white/80 backdrop-blur-sm shadow-md hover:shadow-lg transform hover:scale-105 group"
        >
                ...
                <div>
                  ...
                  <div className="mt-4 sm:mt-6 flex flex-wrap items-center gap-4">
                    ...
                    <div className="flex items-center text-blue-200">
                      ...
                      <span className="text-sm font-medium">Level Dasar</span>
                    </div>
                    <div className="flex items-center text-blue-200">
              ...
              <div className="max-w-4xl">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                  ...
                  <div
                    ...
                    tabIndex={0} // Agar bisa di-scroll pakai keyboard juga
