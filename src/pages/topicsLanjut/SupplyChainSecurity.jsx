...
import { Network, Key, Terminal, Hash, Target, ChevronRight } from 'lucide-react';
...
export const SupplyChainSecurity = {
  ...
  content: <SupplyChainSecurityContent />
};
...
function SupplyChainSecurityContent() {
  ...
  if (currentView === 'quiz') {
    return <SupplyChainQuiz onBack={() => setCurrentView('material')} />;
  }
    ...
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl shadow-xl">
        ...
        <div className="relative z-10 p-8 flex flex-col sm:flex-row items-center gap-6">
          ...
          <div>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-2 drop-shadow">Keamanan Supply Chain</h2>
            <p className="text-blue-100 max-w-2xl text-base sm:text-lg font-medium drop-shadow">
              Supply chain adalah target utama serangan siber modern. Lindungi rantai pasok digital Anda dengan mitigasi risiko, visibilitas vendor, dan framework keamanan terbaru.
            </p>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-2xl border-2 border-blue-200 shadow-md">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-gray-600 mb-4 text-sm">
            Jawab beberapa pertanyaan untuk menguji seberapa baik Anda memahami konsep keamanan supply chain digital.
          </p>
          <button
...
// Quiz Component
function SupplyChainQuiz({ onBack }) {
  const questions = [
    {
      q: "Apa tujuan utama Software Bill of Materials (SBOM)?",
      options: [
        "Meningkatkan performa software",
        "Mendokumentasikan komponen software untuk transparansi dan keamanan",
    ...
    {
      q: "Apa yang dimaksud dengan dependency confusion attack?",
      options: [
        "Serangan pada jaringan vendor",
        "Mengganti dependensi internal dengan paket publik berbahaya",
    ...
    {
      q: "Salah satu mitigasi risiko supply chain adalah...",
      options: [
        "Memberikan akses penuh ke semua vendor",
        "Continuous monitoring terhadap aktivitas vendor",
        "Mengabaikan update software",
        "Menggunakan password yang sama untuk semua vendor"
      ],
      answer: 1
    },
    {
      q: "Apa manfaat utama framework SLSA?",
      options: [
        "Memastikan integritas software dari build hingga distribusi",
        "Mengurangi biaya pengembangan",
        "Meningkatkan kecepatan deployment",
        "Menghapus bug secara otomatis"
      ],
      answer: 0
    },
    {
      q: "Apa yang dimaksud dengan typosquatting dalam supply chain?",
      options: [
        "Menggunakan nama paket yang mirip dengan paket populer untuk menipu pengguna",
        "Mengganti nama vendor",
        "Menghapus dependensi lama",
            ...
            <div className="text-center">
              <div className="mb-8">
                ...
                <p className="text-gray-600 max-w-md mx-auto">
                  {correctCount === questions.length
                    ? "Anda menguasai materi supply chain security dengan sangat baik!"
                    : correctCount >= 3
                    ? "Pemahaman Anda sudah cukup baik tentang supply chain security."
                    : "Anda perlu mempelajari kembali materi supply chain security."}
                </p>
              </div>
