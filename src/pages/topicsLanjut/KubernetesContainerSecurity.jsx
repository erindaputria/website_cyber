...
import { Server, Lock, Terminal, Shield, ChevronRight, Target } from 'lucide-react';
...
export const KubernetesContainerSecurity = {
  ...
  content: <KubernetesContainerSecurityContent />
};

function KubernetesContainerSecurityContent() {
  const [currentView, setCurrentView] = useState('material');

  if (currentView === 'quiz') {
    return <KubernetesQuiz onBack={() => setCurrentView('material')} />;
  }
    ...
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl shadow-xl">
        ...
        <div className="relative z-10 p-8 flex flex-col sm:flex-row items-center gap-6">
          ...
          <div>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-2 drop-shadow">Keamanan Kubernetes & Container</h2>
            <p className="text-blue-100 max-w-2xl text-base sm:text-lg font-medium drop-shadow">
              Dengan 92% organisasi menggunakan Kubernetes dalam produksi, keamanan container menjadi kritis. Ancaman utama termasuk konfigurasi yang salah, runtime vulnerabilities, dan serangan supply chain.
            </p>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-2xl border-2 border-blue-200 shadow-md">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-gray-600 mb-4 text-sm">
            Jawab beberapa pertanyaan untuk menguji seberapa baik Anda memahami konsep keamanan Kubernetes dan container.
          </p>
          <button
...
// Quiz Component
function KubernetesQuiz({ onBack }) {
  const questions = [
    {
      q: "Apa tujuan utama RBAC pada Kubernetes?",
      options: [
        "Mengatur resource limit container",
        "Mengelola akses dan izin pengguna pada cluster",
        "Mempercepat deployment aplikasi",
        "Mengatur network policy"
      ],
      answer: 1
    },
    {
      q: "Apa yang dimaksud dengan container breakout?",
      options: [
        "Container gagal dijalankan",
        "Proses dalam container dapat mengakses host system",
        "Container berjalan tanpa image",
        "Container tidak memiliki storage"
      ],
      answer: 1
    },
    {
      q: "Salah satu praktik keamanan container adalah...",
      options: [
        "Menonaktifkan image scanning",
        "Menggunakan image dari registry tidak resmi",
        "Menjalankan container sebagai root",
        "Menerapkan runtime security monitoring"
      ],
      answer: 3
    },
    {
      q: "Apa manfaat utama menggunakan OPA/Gatekeeper di Kubernetes?",
      options: [
        "Membuat dashboard monitoring",
        "Policy enforcement otomatis pada resource cluster",
        "Mempercepat build image",
        "Menghapus pod secara otomatis"
      ],
      answer: 1
    },
    {
      q: "Apa yang dimaksud dengan immutable infrastructure?",
      options: [
        "Infrastruktur yang dapat diubah kapan saja",
        "Infrastruktur yang tidak berubah setelah deployment",
        "Infrastruktur tanpa backup",
        "Infrastruktur tanpa monitoring"
      ],
      answer: 1
    }
  ];
        ...
        <div className="bg-gradient-to-r from-blue-700 to-indigo-800 p-6 text-white">
          <div className="flex justify-between items-center">
            <div>
              ...
              <h2 className="text-2xl font-bold">Kubernetes & Container Security</h2>
            </div>
            ...
            <div className="text-center">
              <div className="mb-8">
                ...
                <p className="text-gray-600 max-w-md mx-auto">
                  {correctCount === questions.length
                    ? "Anda menguasai materi Kubernetes & container security dengan sangat baik!"
                    : correctCount >= 3
                    ? "Pemahaman Anda sudah cukup baik tentang Kubernetes & container security."
                    : "Anda perlu mempelajari kembali materi Kubernetes & container security."}
                </p>
              </div>
